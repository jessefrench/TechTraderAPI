...
namespace Tech_Trader_Server.Migrations
{
    ...
    [Migration("20241123175421_UserPaymentTypes")]
    partial class UserPaymentTypes
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PaymentTypeUser", b =>
                {
                    b.HasOne("TechTrader.Models.PaymentType", null)
                        .WithMany()
                        .HasForeignKey("PaymentTypesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TechTrader.Models.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("TechTrader.Models.Listing", b =>
                {
                    ...
                    b.HasOne("TechTrader.Models.User", "Seller")
                        .WithMany()
